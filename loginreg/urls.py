...
# Your URL patterns go herefrom django.urls import path
# from . import views
from django.urls import path
from . import views
...
urlpatterns = [ 
    ...
    path('login', views.loginUser, name="login"),  # Add a trailing slash
path('logout/', views.logoutUser, name="logout"),  # Add a trailing slash
